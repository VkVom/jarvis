...
def request_admin_access():
    try:
        if ctypes.windll.shell32.IsUserAnAdmin():
            ...
            text_to_speech("Requesting administrator access.")
            ctypes.windll.shell32.ShellExecuteW(None, "runas", sys.executable, __file__, None, 1)
            return False
    except Exception as e:
        print(f"An error occurred while requesting admin access: {e}")
        text_to_speech(f"An error occurred while requesting admin access: {e}")
        return False
